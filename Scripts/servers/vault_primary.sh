...
FQDN=vault-1.lab.internal
PEER_FQDN=vault-2.lab.internal
...
LAN_PREFIX_V4=24
GATEWAY_V4=10.0.0.1
PEER_IP_V4=10.0.0.11

LAN_IP_V6=fd00:10::10
LAN_PREFIX_V6=64
GATEWAY_V6=fd00:10::1
PEER_IP_V6=fd00:10::11
...
configure_packages() {
    ...
    ensure_packages ipa-client chrony nftables openssh-server git systemd-networkd dnf-plugins-core keepalived haproxy
}
...
listen vault_api
    ...
    server vault-1 10.0.0.10:8200 check
    server vault-2 10.0.0.11:8200 check
EOT
